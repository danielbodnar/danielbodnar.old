...
Interested in growth opportunities related to low-level Linux, networking, embedded development, and cloud-native technologies. Passionate about Linux, containerization, and building scalable, highly available, robust systems.
...
[My cognitive stack](#-cognitive-profile-ti-ne-si-fe-intp) allows me to excel in understanding complex systems, generating innovative solutions, and adapting quickly to new technological paradigms. It also drives a continuous pursuit of knowledge and improvement, making me well-suited for roles that require deep technical expertise and creative problem-solving.
...
### 📊 Cognitive Stack Profile: Ti-Ne-Si-Fe (INTP)
...
<details>
<summary>Toggle: Cognitive Stack Details</summary>
...
This cognitive stack allows me to excel in understanding complex systems, generating innovative solutions, and adapting quickly to new technological paradigms. It also drives a continuous pursuit of knowledge and improvement, making me well-suited for roles that require deep technical expertise and creative problem-solving.
...
- **Networking**: OSI Layer 1-7 configuration, software-defined networking, BGP
...
<details>
<summary>Toggle Details - Preferred Tech Stack</summary>
...
- **Operating Systems**: Linux (Arch Linux, Alpine, WolfiOS, embedded, and good ol' LinuxFromScratch / Buildroot, not to mention the hundreds of other distros I use on at least a monthly basis), OpenBSD / FreeBSD (mostly on routers), and Windows (when absolutely necessary - I avoid it at all costs)
- **Containerization/Orchestration**: Linux containers / namespaces (e.g. unshare, podman, docker, OCI standards stack, etc), Kubernetes, Buildroot, WolfiOS, DevContainers, LocalStack
- **Languages**: Rust, JavaScript/TypeScript, Bash/Shell (I prefer NuShell), Go, Lua, Python (when absolutely necessary), too many more to list...
- **Frontend Frameworks**:  WebComponents, Vue / Nuxt, SolidJS, Lit, Svelte, Alpine.js, and way, way more...
- **Backend**: Node, Rust, Go
- **Infrastructure**: GitHub Actions, Ansible, Pulumi, Terraform, GitLab CI/CD, Packer, CloudFormation, CDK, Crossplane, and a full range of Kubernetes stacks and tools (k3s, k0s, k8s, k3d, kind, minikube, k9s, kubectl, helm, fluxcd, argocd, etc), etc...
- **Cloud Providers**: [BitBuilder Cloud, LLC](#bitbuilder-cloud-llc), Bare Metal (preferred), Fly.io, Bunny.net, GCP, AWS (when unavoidable), Vultr, OVH Cloud, DigitalOcean,
- **Databases**: PostgreSQL, SQLite, DuckDB, MySQL, MongoDB, Redis / ValKey, Memcached, InfluxDB, TimescaleDB, Prometheus, Grafana, VictoriaMetrics, Loki, and more...
- **Monitoring & Observability**: Grafana, Prometheus, VictoriaMetrics, NetData, Jaeger, ELK, Zabbix, and more...
- **Security**: Wazuh, SecurityOnion, OpenVAS, Nessus, Trivy, Vuls.io, WireGuard, Teleport, Falco, ClamAV, Suricata, Snort, and more...
- **Networking**: Linux Networking Protocols and Interfaces (including OSI Layers 1-7), VyOS, WireGuard, ZeroTier, Tailscale, OpenVPN, and more...
- **API Development**: OpenAPI, JSON Schema, GraphQL, gRPC, tRPC, Protocol Buffers, json-rpc, and more...
- **Configuration Languages**: Cue, Dhall, HCL, YAML, JSON, TOML, INI, and more...
...
**What I Look for from Teams:**

- Freedom to contribute insights and efficiency / automation improvements throughout properly scoped projects
...
- Teammates who excel at maintaining systems while being open to innovation and improvement
